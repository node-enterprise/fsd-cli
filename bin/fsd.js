...
<style scoped lang="scss"></style>
    `.trim()}};var Yn=au(De()),Xn=D=>({filename:`${(0,Yn.paramCase)(D)}.types.ts`,content:`
export interface IProps {}

export interface IEmits {}
  `.trim()});var ft=au(De()),Zn=(D,u)=>{let e=`use${(0,ft.pascalCase)(D)}`;return{filename:`${e}.ts`,content:`
...
export default function ${e}(
  ...
  return {};
    ...
    `.trim()}};var Jn=[Xn,Kn,zn,Zn];var pt=au(De());var ke=au(require("node:process"),1);function Xt({onlyFirst:D=!1}={}){let u=["[\\u001B\\u009B][[\\]()#;?]*(?:(?:(?:(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]+)*|[a-zA-Z\\d]+(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]*)*)?\\u0007)","(?:(?:\\d{1,4}(?:;\\d{0,4})*)?[\\dA-PR-TZcf-ntqry=><~]))"].join("|");return new RegExp(u,D?void 0:"g")}var Wo=Xt();function je(D){if(typeof D!="string")throw new TypeError(`Expected a \`string\`, got \`${typeof D}\``);return D.replace(Wo,"")}var tr=au(Jt(),1),Dr=au(er(),1);function du(D,u={}){if(typeof D!="string"||D.length===0||(u={ambiguousIsNarrow:!0,...u},D=je(D),D.length===0))return 0;D=D.replace((0,Dr.default)(),"  ");let t=u.ambiguousIsNarrow?1:2,e=0;for(let n of D){let r=n.codePointAt(0);if(r<=31||r>=127&&r<=159||r>=768&&r<=879)continue;switch(tr.default.eastAsianWidth(n)){case"F":case"W":e+=2;break;case"A":e+=t;break;default:e+=1}}return e}var nr=(D=0)=>u=>`\x1B[${u+D}m`,rr=(D=0)=>u=>`\x1B[${38+D};5;${u}m`,ir=(D=0)=>(u,t,e)=>`\x1B[${38+D};2;${u};${t};${e}m`,iu={modifier:{reset:[0,0],bold:[1,22],dim:[2,22],italic:[3,23],underline:[4,24],overline:[53,55],inverse:[7,27],hidden:[8,28],strikethrough:[9,29]},color:{black:[30,39],red:[31,39],green:[32,39],yellow:[33,39],blue:[34,39],magenta:[35,39],cyan:[36,39],white:[37,39],blackBright:[90,39],gray:[90,39],grey:[90,39],redBright:[91,39],greenBright:[92,39],yellowBright:[93,39],blueBright:[94,39],magentaBright:[95,39],cyanBright:[96,39],whiteBright:[97,39]},bgColor:{bgBlack:[40,49],bgRed:[41,49],bgGreen:[42,49],bgYellow:[43,49],bgBlue:[44,49],bgMagenta:[45,49],bgCyan:[46,49],bgWhite:[47,49],bgBlackBright:[100,49],bgGray:[100,49],bgGrey:[100,49],bgRedBright:[101,49],bgGreenBright:[102,49],bgYellowBright:[103,49],bgBlueBright:[104,49],bgMagentaBright:[105,49],bgCyanBright:[106,49],bgWhiteBright:[107,49]}},R0=Object.keys(iu.modifier),$o=Object.keys(iu.color),ko=Object.keys(iu.bgColor),v0=[...$o,...ko];function Ho(){let D=new Map;for(let[u,t]of Object.entries(iu)){for(let[e,n]of Object.entries(t))iu[e]={open:`\x1B[${n[0]}m`,close:`\x1B[${n[1]}m`},t[e]=iu[e],D.set(n[0],n[1]);Object.defineProperty(iu,u,{value:t,enumerable:!1})}return Object.defineProperty(iu,"codes",{value:D,enumerable:!1}),iu.color.close="\x1B[39m",iu.bgColor.close="\x1B[49m",iu.color.ansi=nr(),iu.color.ansi256=rr(),iu.color.ansi16m=ir(),iu.bgColor.ansi=nr(10),iu.bgColor.ansi256=rr(10),iu.bgColor.ansi16m=ir(10),Object.defineProperties(iu,{rgbToAnsi256:{value(u,t,e){return u===t&&t===e?u<8?16:u>248?231:Math.round((u-8)/247*24)+232:16+36*Math.round(u/255*5)+6*Math.round(t/255*5)+Math.round(e/255*5)},enumerable:!1},hexToRgb:{value(u){let t=/[a-f\d]{6}|[a-f\d]{3}/i.exec(u.toString(16));if(!t)return[0,0,0];let[e]=t;e.length===3&&(e=[...e].map(r=>r+r).join(""));let n=Number.parseInt(e,16);return[n>>16&255,n>>8&255,n&255]},enumerable:!1},hexToAnsi256:{value:u=>iu.rgbToAnsi256(...iu.hexToRgb(u)),enumerable:!1},ansi256ToAnsi:{value(u){if(u<8)return 30+u;if(u<16)return 90+(u-8);let t,e,n;if(u>=232)t=((u-232)*10+8)/255,e=t,n=t;else{u-=16;let s=u%36;t=Math.floor(u/36)/5,e=Math.floor(s/6)/5,n=s%6/5}let r=Math.max(t,e,n)*2;if(r===0)return 30;let i=30+(Math.round(n)<<2|Math.round(e)<<1|Math.round(t));return r===2&&(i+=60),i},enumerable:!1},rgbToAnsi:{value:(u,t,e)=>iu.ansi256ToAnsi(iu.rgbToAnsi256(u,t,e)),enumerable:!1},hexToAnsi:{value:u=>iu.ansi256ToAnsi(iu.hexToAnsi256(u)),enumerable:!1}}),iu}var Uo=Ho(),Pu=Uo;var ht=au(require("node:process"),1),or=au(require("node:os"),1),Qt=au(require("node:tty"),1);function Iu(D,u=globalThis.Deno?globalThis.Deno.args:ht.default.argv){let t=D.startsWith("-")?"":D.length===1?"-":"--",e=u.indexOf(t+D),n=u.indexOf("--");return e!==-1&&(n===-1||e<n)}var{env:lu}=ht.default,_t;Iu("no-color")||Iu("no-colors")||Iu("color=false")||Iu("color=never")?_t=0:(Iu("color")||Iu("colors")||Iu("color=true")||Iu("color=always"))&&(_t=1);function Go(){if("FORCE_COLOR"in lu)return lu.FORCE_COLOR==="true"?1:lu.FORCE_COLOR==="false"?0:lu.FORCE_COLOR.length===0?1:Math.min(Number.parseInt(lu.FORCE_COLOR,10),3)}function qo(D){return D===0?!1:{level:D,hasBasic:!0,has256:D>=2,has16m:D>=3}}function Vo(D,{streamIsTTY:u,sniffFlags:t=!0}={}){let e=Go();e!==void 0&&(_t=e);let n=t?_t:e;if(n===0)return 0;if(t){if(Iu("color=16m")||Iu("color=full")||Iu("color=truecolor"))return 3;if(Iu("color=256"))return 2}if("TF_BUILD"in lu&&"AGENT_NAME"in lu)return 1;if(D&&!u&&n===void 0)return 0;let r=n||0;if(lu.TERM==="dumb")return r;if(ht.default.platform==="win32"){let i=or.default.release().split(".");return Number(i[0])>=10&&Number(i[2])>=10586?Number(i[2])>=14931?3:2:1}if("CI"in lu)return"GITHUB_ACTIONS"in lu||"GITEA_ACTIONS"in lu?3:["TRAVIS","CIRCLECI","APPVEYOR","GITLAB_CI","BUILDKITE","DRONE"].some(i=>i in lu)||lu.CI_NAME==="codeship"?1:r;if("TEAMCITY_VERSION"in lu)return/^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(lu.TEAMCITY_VERSION)?1:0;if(lu.COLORTERM==="truecolor"||lu.TERM==="xterm-kitty")return 3;if("TERM_PROGRAM"in lu){let i=Number.parseInt((lu.TERM_PROGRAM_VERSION||"").split(".")[0],10);switch(lu.TERM_PROGRAM){case"iTerm.app":return i>=3?3:2;case"Apple_Terminal":return 2}}return/-256(color)?$/i.test(lu.TERM)?2:/^screen|^xterm|^vt100|^vt220|^rxvt|color|ansi|cygwin|linux/i.test(lu.TERM)||"COLORTERM"in lu?1:r}function sr(D,u={}){let t=Vo(D,{streamIsTTY:D&&D.isTTY,...u});return qo(t)}var zo={stdout:sr({isTTY:Qt.default.isatty(1)}),stderr:sr({isTTY:Qt.default.isatty(2)})},ar=zo;function lr(D,u,t){let e=D.indexOf(u);if(e===-1)return D;let n=u.length,r=0,i="";do i+=D.slice(r,e)+u+t,r=e+n,e=D.indexOf(u,r);while(e!==-1);return i+=D.slice(r),i}function cr(D,u,t,e){let n=0,r="";do{let i=D[e-1]==="\r";r+=D.slice(n,i?e-1:e)+u+(i?`\r
`:`
`)+t,n=e+1,e=D.indexOf(`
`,n)}while(e!==-1);return r+=D.slice(n),r}var{stdout:fr,stderr:_r}=ar,uD=Symbol("GENERATOR"),Ae=Symbol("STYLER"),Pe=Symbol("IS_EMPTY"),hr=["ansi","ansi","ansi256","ansi16m"],Te=Object.create(null),Ko=(D,u={})=>{if(u.level&&!(Number.isInteger(u.level)&&u.level>=0&&u.level<=3))throw new Error("The `level` option should be an integer from 0 to 3");let t=fr?fr.level:0;D.level=u.level===void 0?t:u.level};var Yo=D=>{let u=(...t)=>t.join(" ");return Ko(u,D),Object.setPrototypeOf(u,We.prototype),u};function We(D){return Yo(D)}Object.setPrototypeOf(We.prototype,Function.prototype);for(let[D,u]of Object.entries(Pu))Te[D]={get(){let t=Ft(this,tD(u.open,u.close,this[Ae]),this[Pe]);return Object.defineProperty(this,D,{value:t}),t}};Te.visible={get(){let D=Ft(this,this[Ae],!0);return Object.defineProperty(this,"visible",{value:D}),D}};var eD=(D,u,t,...e)=>D==="rgb"?u==="ansi16m"?Pu[t].ansi16m(...e):u==="ansi256"?Pu[t].ansi256(Pu.rgbToAnsi256(...e)):Pu[t].ansi(Pu.rgbToAnsi(...e)):D==="hex"?eD("rgb",u,t,...Pu.hexToRgb(...e)):Pu[t][D](...e),Xo=["rgb","hex","ansi256"];for(let D of Xo){Te[D]={get(){let{level:t}=this;return function(...e){let n=tD(eD(D,hr[t],"color",...e),Pu.color.close,this[Ae]);return Ft(this,n,this[Pe])}}};let u="bg"+D[0].toUpperCase()+D.slice(1);Te[u]={get(){let{level:t}=this;return function(...e){let n=tD(eD(D,hr[t],"bgColor",...e),Pu.bgColor.close,this[Ae]);return Ft(this,n,this[Pe])}}}}var Zo=Object.defineProperties(()=>{},{...Te,level:{enumerable:!0,get(){return this[uD].level},set(D){this[uD].level=D}}}),tD=(D,u,t)=>{let e,n;return t===void 0?(e=D,n=u):(e=t.openAll+D,n=u+t.closeAll),{open:D,close:u,openAll:e,closeAll:n,parent:t}},Ft=(D,u,t)=>{let e=(...n)=>Jo(e,n.length===1?""+n[0]:n.join(" "));return Object.setPrototypeOf(e,Zo),e[uD]=D,e[Ae]=u,e[Pe]=t,e},Jo=(D,u)=>{if(D.level<=0||!u)return D[Pe]?"":u;let t=D[Ae];if(t===void 0)return u;let{openAll:e,closeAll:n}=t;if(u.includes("\x1B"))for(;t!==void 0;)u=lr(u,t.close,t.open),t=t.parent;let r=u.indexOf(`
`);return r!==-1&&(u=cr(u,n,e,r)),e+u+n};Object.defineProperties(We.prototype,Te);var Qo=We(),P0=We({level:_r?_r.level:0});var Ru=Qo;function DD({onlyFirst:D=!1}={}){let u=["[\\u001B\\u009B][[\\]()#;?]*(?:(?:(?:(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]+)*|[a-zA-Z\\d]+(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]*)*)?\\u0007)","(?:(?:\\d{1,4}(?:;\\d{0,4})*)?[\\dA-PR-TZcf-ntqry=><~]))"].join("|");return new RegExp(u,D?void 0:"g")}var ua=DD();function nD(D){if(typeof D!="string")throw new TypeError(`Expected a \`string\`, got \`${typeof D}\``);return D.replace(ua,"")}var Er=au(Jt(),1),dr=au(Cr(),1);function rD(D,u={}){if(typeof D!="string"||D.length===0||(u={ambiguousIsNarrow:!0,...u},D=nD(D),D.length===0))return 0;D=D.replace((0,dr.default)(),"  ");let t=u.ambiguousIsNarrow?1:2,e=0;for(let n of D){let r=n.codePointAt(0);if(r<=31||r>=127&&r<=159||r>=768&&r<=879)continue;switch(Er.default.eastAsianWidth(n)){case"F":case"W":e+=2;break;case"A":e+=t;break;default:e+=1}}return e}function Ct(D){let u=0;for(let t of D.split(`
`))u=Math.max(u,rD(t));return u}var Vr=au(sD(),1);var ta=/[\p{Lu}]/u,Da=/[\p{Ll}]/u,mr=/^[\p{Lu}](?![\p{Lu}])/gu,Br=/([\p{Alpha}\p{N}_]|$)/u,oD=/[_.\- ]+/,na=new RegExp("^"+oD.source),Ar=new RegExp(oD.source+Br.source,"gu"),Tr=new RegExp("\\d+"+Br.source,"gu"),ra=(D,u,t,e)=>{let n=!1,r=!1,i=!1,s=!1;for(let f=0;f<D.length;f++){let a=D[f];s=f>2?D[f-3]==="-":!0,n&&ta.test(a)?(D=D.slice(0,f)+"-"+D.slice(f),n=!1,i=r,r=!0,f++):r&&i&&Da.test(a)&&(!s||e)?(D=D.slice(0,f-1)+"-"+D.slice(f-1),i=r,r=!1,n=!0):(n=u(a)===a&&t(a)!==a,i=r,r=t(a)===a&&u(a)!==a)}return D},ia=(D,u)=>(mr.lastIndex=0,D.replace(mr,t=>u(t))),sa=(D,u)=>(Ar.lastIndex=0,Tr.lastIndex=0,D.replace(Ar,(t,e)=>u(e)).replace(Tr,t=>u(t)));function aD(D,u){if(!(typeof D=="string"||Array.isArray(D)))throw new TypeError("Expected the input to be `string | string[]`");if(u={pascalCase:!1,preserveConsecutiveUppercase:!1,...u},Array.isArray(D)?D=D.map(r=>r.trim()).filter(r=>r.length).join("-"):D=D.trim(),D.length===0)return"";let t=u.locale===!1?r=>r.toLowerCase():r=>r.toLocaleLowerCase(u.locale),e=u.locale===!1?r=>r.toUpperCase():r=>r.toLocaleUpperCase(u.locale);return D.length===1?oD.test(D)?"":u.pascalCase?e(D):t(D):(D!==t(D)&&(D=ra(D,t,e,u.preserveConsecutiveUppercase)),D=D.replace(na,""),D=u.preserveConsecutiveUppercase?ia(D,t):t(D),u.pascalCase&&(D=e(D.charAt(0))+D.slice(1)),sa(D,e))}var FD=au(wr(),1);var Nr=(D=0)=>u=>`\x1B[${u+D}m`,Mr=(D=0)=>u=>`\x1B[${38+D};5;${u}m`,jr=(D=0)=>(u,t,e)=>`\x1B[${38+D};2;${u};${t};${e}m`,su={modifier:{reset:[0,0],bold:[1,22],dim:[2,22],italic:[3,23],underline:[4,24],overline:[53,55],inverse:[7,27],hidden:[8,28],strikethrough:[9,29]},color:{black:[30,39],red:[31,39],green:[32,39],yellow:[33,39],blue:[34,39],magenta:[35,39],cyan:[36,39],white:[37,39],blackBright:[90,39],gray:[90,39],grey:[90,39],redBright:[91,39],greenBright:[92,39],yellowBright:[93,39],blueBright:[94,39],magentaBright:[95,39],cyanBright:[96,39],whiteBright:[97,39]},bgColor:{bgBlack:[40,49],bgRed:[41,49],bgGreen:[42,49],bgYellow:[43,49],bgBlue:[44,49],bgMagenta:[45,49],bgCyan:[46,49],bgWhite:[47,49],bgBlackBright:[100,49],bgGray:[100,49],bgGrey:[100,49],bgRedBright:[101,49],bgGreenBright:[102,49],bgYellowBright:[103,49],bgBlueBright:[104,49],bgMagentaBright:[105,49],bgCyanBright:[106,49],bgWhiteBright:[107,49]}},Dc=Object.keys(su.modifier),Fa=Object.keys(su.color),Ca=Object.keys(su.bgColor),nc=[...Fa,...Ca];function Ea(){let D=new Map;for(let[u,t]of Object.entries(su)){for(let[e,n]of Object.entries(t))su[e]={open:`\x1B[${n[0]}m`,close:`\x1B[${n[1]}m`},t[e]=su[e],D.set(n[0],n[1]);Object.defineProperty(su,u,{value:t,enumerable:!1})}return Object.defineProperty(su,"codes",{value:D,enumerable:!1}),su.color.close="\x1B[39m",su.bgColor.close="\x1B[49m",su.color.ansi=Nr(),su.color.ansi256=Mr(),su.color.ansi16m=jr(),su.bgColor.ansi=Nr(10),su.bgColor.ansi256=Mr(10),su.bgColor.ansi16m=jr(10),Object.defineProperties(su,{rgbToAnsi256:{value:(u,t,e)=>u===t&&t===e?u<8?16:u>248?231:Math.round((u-8)/247*24)+232:16+36*Math.round(u/255*5)+6*Math.round(t/255*5)+Math.round(e/255*5),enumerable:!1},hexToRgb:{value:u=>{let t=/[a-f\d]{6}|[a-f\d]{3}/i.exec(u.toString(16));if(!t)return[0,0,0];let[e]=t;e.length===3&&(e=[...e].map(r=>r+r).join(""));let n=Number.parseInt(e,16);return[n>>16&255,n>>8&255,n&255]},enumerable:!1},hexToAnsi256:{value:u=>su.rgbToAnsi256(...su.hexToRgb(u)),enumerable:!1},ansi256ToAnsi:{value:u=>{if(u<8)return 30+u;if(u<16)return 90+(u-8);let t,e,n;if(u>=232)t=((u-232)*10+8)/255,e=t,n=t;else{u-=16;let s=u%36;t=Math.floor(u/36)/5,e=Math.floor(s/6)/5,n=s%6/5}let r=Math.max(t,e,n)*2;if(r===0)return 30;let i=30+(Math.round(n)<<2|Math.round(e)<<1|Math.round(t));return r===2&&(i+=60),i},enumerable:!1},rgbToAnsi:{value:(u,t,e)=>su.ansi256ToAnsi(su.rgbToAnsi256(u,t,e)),enumerable:!1},hexToAnsi:{value:u=>su.ansi256ToAnsi(su.hexToAnsi256(u)),enumerable:!1}}),su}var da=Ea(),Pr=da;var dt=new Set(["\x1B","\x9B"]),ga=39,_D="\x07",kr="[",pa="]",Hr="m",hD=`${pa}8;;`,Wr=D=>`${dt.values().next().value}${kr}${D}${Hr}`,$r=D=>`${dt.values().next().value}${hD}${D}${_D}`,ma=D=>D.split(" ").map(u=>du(u)),fD=(D,u,t)=>{let e=[...u],n=!1,r=!1,i=du(je(D[D.length-1]));for(let[s,f]of e.entries()){let a=du(f);if(i+a<=t?D[D.length-1]+=f:(D.push(f),i=0),dt.has(f)&&(n=!0,r=e.slice(s+1).join("").startsWith(hD)),n){r?f===_D&&(n=!1,r=!1):f===Hr&&(n=!1);continue}i+=a,i===t&&s<e.length-1&&(D.push(""),i=0)}!i&&D[D.length-1].length>0&&D.length>1&&(D[D.length-2]+=D.pop())},Aa=D=>{let u=D.split(" "),t=u.length;for(;t>0&&!(du(u[t-1])>0);)t--;return t===u.length?D:u.slice(0,t).join(" ")+u.slice(t).join("")},Ta=(D,u,t={})=>{if(t.trim!==!1&&D.trim()==="")return"";let e="",n,r,i=ma(D),s=[""];for(let[a,_]of D.split(" ").entries()){t.trim!==!1&&(s[s.length-1]=s[s.length-1].trimStart());let A=du(s[s.length-1]);if(a!==0&&(A>=u&&(t.wordWrap===!1||t.trim===!1)&&(s.push(""),A=0),(A>0||t.trim===!1)&&(s[s.length-1]+=" ",A++)),t.hard&&i[a]>u){let b=u-A,W=1+Math.floor((i[a]-b-1)/u);Math.floor((i[a]-1)/u)<W&&s.push(""),fD(s,_,u);continue}if(A+i[a]>u&&A>0&&i[a]>0){if(t.wordWrap===!1&&A<u){fD(s,_,u);continue}s.push("")}if(A+i[a]>u&&t.wordWrap===!1){fD(s,_,u);continue}s[s.length-1]+=_}t.trim!==!1&&(s=s.map(a=>Aa(a)));let f=[...s.join(`
`)];for(let[a,_]of f.entries()){if(e+=_,dt.has(_)){let{groups:b}=new RegExp(`(?:\\${kr}(?<code>\\d+)m|\\${hD}(?<uri>.*)${_D})`).exec(f.slice(a).join(""))||{groups:{}};if(b.code!==void 0){let W=Number.parseFloat(b.code);n=W===ga?void 0:W}else b.uri!==void 0&&(r=b.uri.length===0?void 0:b.uri)}let A=Pr.codes.get(Number(n));f[a+1]===`
`?(r&&(e+=$r("")),n&&A&&(e+=Wr(A))):_===`
`&&(n&&A&&(e+=Wr(n)),r&&(e+=$r(r)))}return e};function gt(D,u,t){return String(D).normalize().replace(/\r\n/g,`
`).split(`
`).map(e=>Ta(e,u,t)).join(`
`)}var Oa=au(sD(),1),Ju=`
`,pu=" ",He="none",zr=()=>{let{env:D,stdout:u,stderr:t}=ke.default;return u?.columns?u.columns:t?.columns?t.columns:D.COLUMNS?Number.parseInt(D.COLUMNS,10):80},Ur=D=>typeof D=="number"?{top:D,right:D*3,bottom:D,left:D*3}:{top:0,right:0,bottom:0,left:0,...D},Ue=D=>D===He?0:2,Ba=D=>{let u=["topLeft","topRight","bottomRight","bottomLeft","left","right","top","bottom"],t;if(D===He){D={};for(let e of u)D[e]=""}if(typeof D=="string"){if(t=Vr.default[D],!t)throw new TypeError(`Invalid border style: ${D}`)}else{typeof D?.vertical=="string"&&(D.left=D.vertical,D.right=D.vertical),typeof D?.horizontal=="string"&&(D.top=D.horizontal,D.bottom=D.horizontal);for(let e of u)if(D[e]===null||typeof D[e]!="string")throw new TypeError(`Invalid border style: ${e}`);t=D}return t},ba=(D,u,t)=>{let e="",n=du(D);switch(t){case"left":{e=D+u.slice(n);break}case"right":{e=u.slice(n)+D;break}default:{u=u.slice(n),u.length%2===1?(u=u.slice(Math.floor(u.length/2)),e=u.slice(1)+D+u):(u=u.slice(u.length/2),e=u+D+u);break}}return e},La=(D,{padding:u,width:t,textAlignment:e,height:n})=>{D=(0,FD.default)(D,{align:e});let r=D.split(Ju),i=Ct(D),s=t-u.left-u.right;if(i>s){let _=[];for(let A of r){let b=gt(A,s,{hard:!0}),L=(0,FD.default)(b,{align:e}).split(`
`),m=Math.max(...L.map(F=>du(F)));for(let F of L){let k;switch(e){case"center":{k=pu.repeat((s-m)/2)+F;break}case"right":{k=pu.repeat(s-m)+F;break}default:{k=F;break}}_.push(k)}}r=_}e==="center"&&i<s?r=r.map(_=>pu.repeat((s-i)/2)+_):e==="right"&&i<s&&(r=r.map(_=>pu.repeat(s-i)+_));let f=pu.repeat(u.left),a=pu.repeat(u.right);return r=r.map(_=>f+_+a),r=r.map(_=>{if(t-du(_)>0)switch(e){case"center":return _+pu.repeat(t-du(_));case"right":return _+pu.repeat(t-du(_));default:return _+pu.repeat(t-du(_))}return _}),u.top>0&&(r=[...Array.from({length:u.top}).fill(pu.repeat(t)),...r]),u.bottom>0&&(r=[...r,...Array.from({length:u.bottom}).fill(pu.repeat(t))]),n&&r.length>n?r=r.slice(0,n):n&&r.length<n&&(r=[...r,...Array.from({length:n-r.length}).fill(pu.repeat(t))]),r.join(Ju)},xa=(D,u,t)=>{let e=_=>{let A=t.borderColor?Ra(t.borderColor)(_):_;return t.dimBorder?Ru.dim(A):A},n=_=>t.backgroundColor?va(t.backgroundColor)(_):_,r=Ba(t.borderStyle),i=zr(),s=pu.repeat(t.margin.left);if(t.float==="center"){let _=Math.max((i-u-Ue(t.borderStyle))/2,0);s=pu.repeat(_)}else if(t.float==="right"){let _=Math.max(i-u-t.margin.right-Ue(t.borderStyle),0);s=pu.repeat(_)}let f="";t.margin.top&&(f+=Ju.repeat(t.margin.top)),(t.borderStyle!==He||t.title)&&(f+=e(s+r.topLeft+(t.title?ba(t.title,r.top.repeat(u),t.titleAlignment):r.top.repeat(u))+r.topRight)+Ju);let a=D.split(Ju);return f+=a.map(_=>s+e(r.left)+n(_)+e(r.right)).join(Ju),t.borderStyle!==He&&(f+=Ju+e(s+r.bottomLeft+r.bottom.repeat(u)+r.bottomRight)),t.margin.bottom&&(f+=Ju.repeat(t.margin.bottom)),f},ya=D=>{if(D.fullscreen&&ke.default?.stdout){let u=[ke.default.stdout.columns,ke.default.stdout.rows];typeof D.fullscreen=="function"&&(u=D.fullscreen(...u)),D.width||(D.width=u[0]),D.height||(D.height=u[1])}return D.width&&(D.width=Math.max(1,D.width-Ue(D.borderStyle))),D.height&&(D.height=Math.max(1,D.height-Ue(D.borderStyle))),D},Gr=(D,u)=>u===He?D:` ${D} `,Ia=(D,u)=>{u=ya(u);let t=u.width!==void 0,e=zr(),n=Ue(u.borderStyle),r=e-u.margin.left-u.margin.right-n,i=Ct(gt(D,e-n,{hard:!0,trim:!1}))+u.padding.left+u.padding.right;if(u.title&&t?(u.title=u.title.slice(0,Math.max(0,u.width-2)),u.title&&(u.title=Gr(u.title,u.borderStyle))):u.title&&(u.title=u.title.slice(0,Math.max(0,r-2)),u.title&&(u.title=Gr(u.title,u.borderStyle),du(u.title)>i&&(u.width=du(u.title)))),u.width=u.width?u.width:i,!t){if(u.margin.left&&u.margin.right&&u.width>r){let f=(e-u.width-n)/(u.margin.left+u.margin.right);u.margin.left=Math.max(0,Math.floor(u.margin.left*f)),u.margin.right=Math.max(0,Math.floor(u.margin.right*f))}u.width=Math.min(u.width,e-n-u.margin.left-u.margin.right)}return u.width-(u.padding.left+u.padding.right)<=0&&(u.padding.left=0,u.padding.right=0),u.height&&u.height-(u.padding.top+u.padding.bottom)<=0&&(u.padding.top=0,u.padding.bottom=0),u},CD=D=>D.match(/^#(?:[0-f]{3}){1,2}$/i),qr=D=>typeof D=="string"&&(Ru[D]??CD(D)),Ra=D=>CD(D)?Ru.hex(D):Ru[D],va=D=>CD(D)?Ru.bgHex(D):Ru[aD(["bg",D])];function ED(D,u){if(u={padding:0,borderStyle:"single",dimBorder:!1,textAlignment:"left",float:"left",titleAlignment:"left",...u},u.align&&(u.textAlignment=u.align),u.borderColor&&!qr(u.borderColor))throw new Error(`${u.borderColor} is not a valid borderColor`);if(u.backgroundColor&&!qr(u.backgroundColor))throw new Error(`${u.backgroundColor} is not a valid backgroundColor`);return u.padding=Ur(u.padding),u.margin=Ur(u.margin),u=Ia(D,u),D=La(D,u),xa(D,u.width,u)}var Yr=D=>({value:D,log:()=>console.log(D)}),re=D=>{let u=D.status||"blue",t=Ru[u](D.title);return D.text&&(t+=` ${D.text}`),D.bold&&(t=Ru.bold(t)),t=t.trim(),Yr(t)},Xr=(D,u)=>{let t=ED(u,{title:D,titleAlignment:"center",borderColor:"blue"});return Yr(t)};var Jr=au(De());var Zr={page:(D,u)=>((0,Jr.pascalCase)(D).slice(-4)!=="Page"&&(D+="Page"),{sliceName:D,sliceType:u})},Qr=(D,u)=>Zr[u]&&Zr[u](D,u)||{sliceName:D,sliceType:u};var wa=["src","lib"],Na=(D,u)=>{let t=`${D}/${u}`;return ie.default.existsSync(t)||ie.default.mkdirSync(t),t},Ma=(D,u,t)=>{let e=`${D}/${u}/${(0,pt.paramCase)(t)}`;return ie.default.existsSync(e)||ie.default.mkdirSync(e),e},ja=(D,u)=>{let t=`${D}/${u.filename}`;ie.default.existsSync(t)?re({title:"EXIST",text:u.filename,status:"blackBright"}).log():ie.default.writeFile(t,u.content,{encoding:"utf-8"},e=>{e?re({title:"FAILED CREATE",text:u.filename,status:"red"}).log():re({title:"CREATED",text:u.filename,status:"green"}).log()})},Pa=(D,u,t)=>{re({title:`${(0,pt.pascalCase)(D)} generation`,bold:!0}).log(),Jn.forEach(e=>ja(t,e(u,D)))},ui=(D,u)=>{let{sliceName:t,sliceType:e}=Qr(D,u),n=new we(wa).findSourcePath();if(!n)throw new Error("Source path not found");Na(n,e),Pa(e,t,Ma(n,e,t))};var Os=au(Ts()),Ss=au(bs());var Ls=`flf2a$ 6 5 16 15 13 0 24463 229
...
0xCA0  KANNADA LETTER TTHA
 ...
 $\\___/$ @
         @@
         `;var rn=au(Is());var Rs=()=>{rn.default.parseFont("Standard",Ls),(0,rn.default)("FSD CLI",(D,u)=>D?console.error(D):console.log(Ru.blue(u)))},vs=D=>{let u=[];for(let t in D){let e=D[t];u.push(re({title:e.description,text:`"${e.example}"`,status:"blackBright"}).value)}Xr("Command examples",u.join(`
`)).log()};var sn={widget:{alias:"w",description:"Generate widget",example:"fsd g -w cart"},page:{alias:"p",description:"Generate page",example:"fsd g -p registration"},feature:{alias:"f",description:"Generate feature",example:"fsd g -f cartItem"},entity:{alias:"e",description:"Generate entity",example:"fsd g -e cart-item-details"},module:{alias:"m",description:"Generate module",example:"fsd g -m userProfile"},component:{alias:"c",description:"Generate component",example:"fsd g -c table"}},ws=(0,Ss.hideBin)(process.argv);ws.length||(Rs(),vs(sn));(0,Os.default)(ws).command({command:"generate",describe:"Generate slice",aliases:["g"],builder:sn,handler:D=>{for(let u in sn)D[u]&&ui(D[u],u)}}).alias({h:"help",v:"version"}).demandCommand().parse();
